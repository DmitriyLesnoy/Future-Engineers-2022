...
while 1:
    ...
    if state=='main':
        ...
        if direction is None:
            ...
            if time.time()>=timer_line+0.17 and flag_line:
                flag_line=False
                count_lines+=1
        ...
        if flag_count and not count_green and not count_red and time.time()>=timer_count+0.1:
            flag_count=False
            boxes[c_box-1]+=1
        ...
        p = int(delta_reg * 0.1 + (delta_reg - delta_reg_old) * 0.1)
